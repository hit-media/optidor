(function (a) {
    a.fn.ppGallery = function (d) {
        ...
        function s(b) {
            ...
            e <= b ? a("#sliderpp").hide() : a("#sliderpp").css({width: "98%", margin: "0 auto"}).slider({min: 0, max: parseInt(f), slide: function (c, h) {
                var i = h.value > f ? -f : -h.value;
                a("#thumbImgpp").css({position: "relative"}).animate({left: i},
                    10, function () {
                    })
            }})
        }
        ...
        function t() {
            ...
            if (d.maxWidth != "")if (newImgW > d.maxWidth) {
                ...
                a(".borderBoxpp img").css({width: d.maxWidth + "px"})
            }
            a("#lightBoxGallerypp").css({left: "" + Math.floor(e / 2.1 - newImgW / 2) + "px", width: newImgW + 50 + "px", top: f + b / 30 + "px"});
            s(newImgW + 50);
            a("#playpp").html("Play");
            a("#coverpp").css({height: b,
                width: e});
            ...
            a(window).resize(function () {
                ...
                a("#lightBoxGallerypp").css({left: "" +
                    Math.floor(h / 2.1 - newImgW / 2) + "px", height: newImgH + 170 + "px"});
                a("#coverpp").css({height: c, width: h})
            });
        ...
        function j(b) {
            ...
            a(".borderBoxpp img").one("load",function () {
                ...
                a(".fadeLoaderpp").fadeOut(function () {
                    ...
                    a("#lightBoxGallerypp").animate({height: newImgH + 170 + "px"}, 500, function () {
                        p()
                    });
                    a("#cpanelpp").css({width: newImgW + "px"});
                    a(".borderBoxpp").css({display: "block"});
                    a("#imageTitlepp").css({width: "99%"});
                    a("#thumbImgpp").css({width: e *
                        d.thumbWidth + (f + c) * e + 10 + "px"});
                    u(h, newImgW);
                    return false
                })
            }).each(function () {
        ...
        function v(b) {
            ...
            h =
                h.left < newImgW / 2 ? 0 : h.left > i - c / 1.8 ? -(i - c) : -h.left + newImgW / 2;
            if (e > c) {
                a("#sliderpp").slider("option", "value", f);
                a("#thumbImgpp").css({position: "relative"}).animate({left: h}, 700, function () {
                })
            }
        ...
        d = a.extend({screenFade: 0.8, screenColor: "#000000", showTitle: 1, thumbWidth: 60, maxWidth: "", slideShowDelay: "3", showHiddenGalleryButton: "", autoOpen: 0}, d);
        var g = "#" + a(this).attr("id");
        if (d.showHiddenGalleryButton != "") {
            a(g).css({display: "none"});
            a(d.showHiddenGalleryButton).css({cursor: "pointer"})
        }
        ...
        var q = function () {
            ...
            if (b == "close") {
                ...
                a("body").data("slideControlactive",
                    "1");
                a("#playpp").html("Stop");
                a("#playpp").unbind();
                a("#playpp").click(function () {
